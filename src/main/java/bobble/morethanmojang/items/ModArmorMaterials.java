...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    BISMUTH("bismuth", 24, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.BISMUTH_FRACTURE));
    ...
    public String getName() {
        return MoreThanMojang.MOD_ID + ":" + this.name;
    }
